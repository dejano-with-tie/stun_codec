...
use crate::net::{SocketAddrDecoder, socket_addr_xor, SocketAddrEncoder};
use crate::Message;
...
///
/// See [RFC 5780 -- 15.11. CHANGE-REQUEST] about this attribute.
///
/// [RFC 5780 -- 15.11. CHANGE-REQUEST]: https://tools.ietf.org/html/rfc5780#section-7.2
...
///
/// See [RFC 5780 -- 15.2. RESPONSE-ORIGIN] about this attribute.
///
/// [RFC 5780 -- 15.2. RESPONSE-ORIGIN]: https://tools.ietf.org/html/rfc5780#section-7.3
#[derive(Debug, Clone, PartialEq, Eq, Hash)]
...
impl_encode!(ResponseOriginEncoder, ResponseOrigin, |item: Self::Item| item
    .0);

/// `OTHER-ADDRESS` attribute.
///
/// See [RFC 5780 -- 15.2. OTHER-ADDRESS] about this attribute.
///
/// [RFC 5780 -- 15.2. OTHER-ADDRESS]: https://tools.ietf.org/html/rfc5780#section-7.4
#[derive(Debug, Clone, PartialEq, Eq, Hash)]
...
impl_decode!(OtherAddressDecoder, OtherAddress, |item| Ok(
    OtherAddress(item)
));
...
impl_encode!(OtherAddressEncoder, OtherAddress, |item: Self::Item| item
    .0);
